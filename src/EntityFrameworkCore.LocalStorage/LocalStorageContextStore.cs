...
{
    public class LocalStorageContextStore : IFileContextStore
    {
        ...
        /// </summary>
        public LocalStorageContextStore([NotNull] IFileContextTableFactory tableFactory)
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public LocalStorageContextStore(
                ...
                if (valuesSeeded)
                {
                    ...
                    foreach (var entityType in updateAdapter.Model.GetEntityTypes())
                    {
                        ...
                        foreach (var targetSeed in entityType.GetSeedData())
                        {
                            ...
                            if (table is IFileContextTableExists fileContextTableExists && fileContextTableExists.Exists(entry))
                            {
